...
# 方法 3: 按作者搜索
git log --author="chenhuazhong@minieye.cc" --since="7 days ago"
```
...
```bash
# PostgreSQL
PGPASSWORD="password" psql -h 192.168.25.200 -p 32432 -U postgres -d event_db

# MySQL
mysql -h 192.168.25.200 -P 3306 -u root -p event_db

# MongoDB
mongo --host 192.168.25.200 --port 27017 -u admin -p event_db
```
...
```bash
# 连接生产环境数据库
PGPASSWORD="post@1234.com" psql -h 192.168.25.200 -p 32432 -U postgres -d event_db
