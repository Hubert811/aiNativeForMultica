...
cat > .env.skill << 'EOF'
# Sentinel 配置 - 测试环境
export TEST_API_URL="http://192.168.25.200:30882/api/v1"
export TEST_DB_HOST="192.168.25.200"
...
# Sentinel 配置 - 生产环境
export PROD_API_URL="http://192.168.25.23:31676/api/v1"
export PROD_DB_HOST="192.168.25.200"
