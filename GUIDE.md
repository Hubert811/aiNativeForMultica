...
# 验证部署
kubectl get pods -n pdcl

# 查看日志
kubectl logs -f deployment/app -n pdcl
```
...
1. 检查 Helm Charts 配置
2. 检查 K8s 集群连接
3. 查看 Helm Release 状态：`helm list -n pdcl`
...
- **[MR !41 示例](https://<git-host>/pdcl/resource-meter/-/merge_requests/41/diffs)** - 包含设计、代码、测试的完整 MR
